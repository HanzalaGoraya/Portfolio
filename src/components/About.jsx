...
const About = () => (
  <section id="about" style={{ padding: "2rem 1rem" }}>
    ...
    <p>
      ...
      <li>Engineered robust back-end services and intuitive front-end interfaces, resulting in improved user engagement and system performance.</li>
      <li>Optimized distributed systems for speed and reliability, leveraging advanced knowledge in object-oriented design, algorithms, and data structures.</li>
     ...
     Values:<br/><br/>
      <p>Passionate about customer satisfaction, inclusivity, and fostering diversity within dynamic, agile work environments.
